...
class Content(Base):
    ...
    voice_path: Mapped[str] = mapped_column(String(1000), default="")
    rendered_media_path: Mapped[str] = mapped_column(String(1000), default="")
...
class VoiceProfile(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    voice_id: Mapped[str] = mapped_column(String(200), unique=True)
    name: Mapped[str] = mapped_column(String(200))
    gender: Mapped[str] = mapped_column(String(30), default="neutral")
    language: Mapped[str] = mapped_column(String(30), default="en")
    model_path: Mapped[str] = mapped_column(String(1000))
